...
class Program
{
  ...
  //     kelime = new string(kelime.Where(c => !char.IsWhiteSpace(c)).ToArray());
  ...
  //ödev17
  // public static int SayiyiBul(List<int> liste, int arananSayi)
  // {
  //   int sayac = 0;
  ...
  // }
  //ödev18
  // public static string TamIsim(string ad, string soyad)
  // {
  ...
  static void Main(string[] args)
  {
    ...
    // string[] kelimeler = { "Merhaba", "canım", "nasılsın" };
